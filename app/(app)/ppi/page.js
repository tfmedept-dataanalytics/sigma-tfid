...
export default async function Page({ searchParams }) {
  ...
  const rows = await getIndicators('PPI', year);
  ...
  return (
    <>
      <div className="page-h">
        <h2>Indicator Repository & Quarterly Update — Program Performance</h2>
      ...
      <IndicatorTable type="PPI" year={year} years={years} role={profile?.role} rows={rows} />
    </>
  );
}
