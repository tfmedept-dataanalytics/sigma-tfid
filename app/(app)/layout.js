...
export default async function AppLayout({ children }) {
  ...
  return (
    <div id="app" className="on">
      ...
      <main className="main">
        {/* Suspense di sini penting: sejumlah view membaca query string lewat
            useSearchParams. Tanpa batas Suspense, Next.js melakukan bailout
            dan hook itu mengembalikan null pada render pertama. */}
