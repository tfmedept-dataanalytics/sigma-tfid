...
import { APP_VERSION, BUILD_DATE, BUILD_NOTES, BUILD, FEATURES } from '@/lib/version';
  ...
  return (
    <div style={{ maxWidth: 780, margin: '48px auto', padding: '0 20px' }}>
      ...
      <div className="note i mb">
        <b>Build yang sedang berjalan: v{APP_VERSION} ({BUILD_DATE}).</b> {BUILD_NOTES}.
        Bila nomor ini berbeda dari rilis terbaru yang Anda terima, deployment belum diperbarui —
        push ke GitHub lalu Redeploy di Vercel.
      </div>
