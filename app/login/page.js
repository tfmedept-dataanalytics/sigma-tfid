    ...
    <div id="login">
      ...
      <div className="lg-left">
        ...
        <div className="lg-hero">
          ...
          <p>{t('Satu platform yang mengintegrasikan Organization Performance Indicators, Regional Performance Indicators melalui pengukuran Balance Score Card (BSC) dan Program Performance Indicators Tanoto Foundation — mulai dari struktur target & aktual per kuartal, bukti, validasi, sampai analisa dan dukungan untuk membuat keputusan.')}</p>
      ...
      <div className="lg-right">
        <form className="lg-form" action={formAction}>
          ...
          <div className="fld">
            <label htmlFor="username">{t('Username atau email')}</label>
            <input id="username" name="username" placeholder={t('nama.pengguna')}
                   autoComplete="username" autoCapitalize="none" spellCheck={false} required />
            <div className="hint">{t('Akun pertama: masuk dengan alamat email yang dibuat di Supabase Dashboard.')}</div>
          </div>
