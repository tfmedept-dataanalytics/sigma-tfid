          ...
          {tab === 'Quarterly Update' && (
            <>
              ...
              <div className="row mb">
                <span className="bdg b-gd">Periode: Q{qtr} {year}</span>
              ...
              <form action={saveAction}>
                ...
                <div className="grid g2">
                  ...
                  <div className="fld"><label>Actual YTD (dihitung otomatis)</label>
                    ...
                    <div className="hint">Agregasi Q1–Q4: {AGG_LABEL[aggMode(ind)]}{ind.agg ? ' — diatur khusus' : ' — aturan umum'}.</div></div>
                </div>

                <div className="note i mb" style={{ margin: '4px 0 14px' }}>
                  Capaian: {a === null
                    ? 'belum dapat dihitung — No Data. Target atau actual belum lengkap.'
                    : `${pct(a)} — ${STATUS_LABEL[statusClass(a)]}.`}
                </div>
