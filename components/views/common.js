...
/** Label periode aktif, dipakai di kepala halaman yang bergantung kuartal. */
export const PeriodChip = ({ year, qtr }) => (
  <Badge cls="b-gd">Periode: Q{qtr} {year}</Badge>
);

/** Nilai kuartal ke-n (1-4) dari satu baris tahun. */
export const qVal = (y, qtr) => (y ? [y.q1, y.q2, y.q3, y.q4][qtr - 1] : null);

/** Berapa indikator yang sudah terisi pada kuartal tersebut. */
export function quarterFill(rows, year, qtr) {
