-- =====================================================================
-- SIGMA — data seed 2/3: nilai per tahun untuk OPI dan PPI (461 baris)
--
...
--
-- Kolom `region` diisi 'National' untuk OPI dan PPI. Kolom itu diperkenalkan
-- migrasi 0008 untuk menampung dimensi region pada RPI; blok ALTER di bawah
-- membuat berkas ini tetap berjalan walau 0008 belum sempat dijalankan.
-- =====================================================================

-- Pastikan kolom dan primary key sudah sesuai, apa pun urutan menjalankannya.
...
('OPI-002',2024,'National',1.0,null,0.0,null,1.0,'Pilot for national survey for ECDI (child outcome measurement age 4-6) by BKKBN is on-going till Dec 2024; 1,500 sample village identified.',null,null,'approved'),
...
('OPI-009',2025,'National',3.0,null,0.0,null,3.0,'Proxy Indicator for 2025 : # of lever programs launched; 1. Teacher New Lever
...
('OPI-011',2025,'National',0.11,null,9.0,null,null,'Successfully influenced RPJMN to incorporate foundational literacy and numeracy. Now, supporting RPJMD to include foundational litnum. 
...
('OPI-033',2025,'National',0.9,null,0.34,null,91.7,'- Total spending TF Indo IDR 170.6b from total budget IDR 186.6b exclude CAPEX.
...
('OPI-042',2025,'National',0.2,null,0.4,null,null,'Proxy indicator for 2025 : Milestones achieved; The finalisation of the RAN PAUD HI is still pending the submission of detailed output annexes from each line ministry serving as task force members. The launch is planned for February 2026.',null,null,'approved'),
