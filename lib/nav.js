...
export const NAV = [
  ...
  { t: 'Regional Performance (RPI)', ic: '◑', items: [
    { id: 'rg-map', l: 'Regional Strategy Map' },
    { id: 'rg-kpi', l: 'KPI Repository' },
    { id: 'rg-qu',  l: 'Quarterly Update' },
    { id: 'rg-cmp', l: 'Regional Comparison' },
    { id: 'rg-ann', l: 'Annual Performance Review' },
    { id: 'rg-an',  l: 'Regional Analytics' }
  ]},
