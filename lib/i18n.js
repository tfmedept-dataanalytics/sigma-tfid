...
const EN = {
  ...
  'Username tidak ditemukan. Akun pertama dibuat di Supabase Dashboard (Authentication → Users) dan masuk dengan alamat emailnya.':
    'Username not found. The first account is created in the Supabase Dashboard (Authentication → Users) and signs in with its email address.',
  'Akun ini belum terdaftar di SIGMA. Minta System Administrator mendaftarkannya melalui Administration › User Management.':
    'This account is not registered in SIGMA yet. Ask the System Administrator to register it in Administration › User Management.',
  'Akun terautentikasi tetapi profilnya belum ada, dan fungsi claim_profile tidak ditemukan. Jalankan 0007_claim_profile.sql di Supabase SQL Editor.':
    'The account authenticated but has no profile, and the claim_profile function is missing. Run 0007_claim_profile.sql in the Supabase SQL Editor.',
  'Akun pertama: masuk dengan alamat email yang dibuat di Supabase Dashboard.':
    'First account: sign in with the email address created in the Supabase Dashboard.',
  ...
  'Akun belum terdaftar di database. Jalankan npm run seed atau npm run create-admin.':
    'No account exists in the database yet. Run npm run seed or npm run create-admin.',
  'Database belum siap: fungsi email_for_username tidak ditemukan. Jalankan file migrasi di Supabase SQL Editor.':
    'The database is not ready: function email_for_username is missing. Run the migration files in the Supabase SQL Editor.',
  'Bisa juga memakai alamat email akun.': 'You can also use the account email address.',
