...
/* /api/setup harus publik: endpoint bootstrap dipakai justru ketika belum ada
   satu pun akun, jadi tidak mungkin melewati pemeriksaan sesi. Pengamanannya
   ada di dalam endpoint itu sendiri - menolak begitu ada administrator aktif. */
const PUBLIC = ['/login', '/setup', '/api/setup'];
